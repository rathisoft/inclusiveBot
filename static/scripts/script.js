...
function submitToSpeech(){

  const inputTxt =  document.getElementById('q').value;
  
  displayMsgDiv(inputTxt, 'User');
  document.getElementById('q').value = '';
  //// Get input text after click submit
  //convert to speech file -blob -- SpeechToTxt
  //call conversation function
  //call play -- Text to Speech
  //call display msg
  $.ajax({
    url: '/api/conversationV1',
    convText: inputTxt,
    context: JSON.stringify(conversationContext),
  })
    .done(function (res) {
